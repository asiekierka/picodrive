...
//---------------------------------------------------------------------------------
	...
	if ( type == FT_DIR || !strcasecmp(".bin",&fileName[len-4]) || !strcasecmp(".gen",&fileName[len-4]) || !strcasecmp(".sms",&fileName[len-4]) || !strcasecmp(".smd",&fileName[len-4]) || !strcasecmp(".68k",&fileName[len-4])) {
